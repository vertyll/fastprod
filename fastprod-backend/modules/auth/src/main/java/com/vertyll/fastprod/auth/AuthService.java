...
class AuthService {
    ...
    public AuthResponseDto authenticate(AuthRequestDto request) {
        ...
        User user = userService.findByEmailWithRoles(request.email()).orElseThrow(() -> new ApiException(
                "User not found",
    ...
    public void verifyAccount(String code) {
        VerificationToken verificationToken = tokenRepository.findByToken(code).orElseThrow(() -> new ApiException(
