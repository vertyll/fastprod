...
public record BaseFilterDto(
        ...
        @Nullable @Min(value = 1, message = "Page size must be at least 1")
    ...
    public Pageable toPageable() {
        ...
        String sortByValue = Objects.requireNonNull(sortBy, "sortBy cannot be null after normalization");
        String sortDirectionValue = Objects.requireNonNull(sortDirection, "sortDirection cannot be null after normalization");

        Sort.Direction direction = "DESC".equals(sortDirectionValue)
                ? Sort.Direction.DESC
                : Sort.Direction.ASC;
